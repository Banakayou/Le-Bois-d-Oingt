...
public class PedestrianSystem : MonoBehaviour 
{
	...
	void Start()
	{
		...
		if(Application.isPlaying)
		{
			...
			foreach (PedestrianNode pn in nodes){
            ...
            while (CanSpawn())
            {
                ...
                {
                    PedestrianObject obj = Instantiate(m_objectPrefabs[m_objectIndex], transform.position, transform.rotation) as PedestrianObject;
